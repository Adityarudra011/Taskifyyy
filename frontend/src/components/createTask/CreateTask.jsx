...
function CreateTask() {
    ...
    return (
        <div className="addContainer md:w-1/3 md:mx-auto mx-3 mt-3 fles justify-center">
            <div className='w-11/12'>
                <form onSubmit={handleAdd}>
                    ...
                    <div className='flex justify-center'>
                        <button
                            type='submit'
                            className=' bg-blue-700 rounded-full text-white px-5 py-1 transform transition-transform duration-300 hover:scale-110'
                        >Add</button>
                    </div>
                </form>
